...
+ (void)fun_point_requst:(NSValue *)touchPoint1
{
    ...
    NSString *event =  [cls_Tool fun_plistText:@"strca_event"];
...
- (void)viewDidLoad {
...

    {
        ...
        [var_button setImage:[cls_Tool fun_imageName:@"img_btn_fh"] forState:UIControlStateNormal];
        var_button.frame = CGRectMake(RPX(40), RPY(20), RPX(50), RPX(50));
...

    {
        ...
        UIButton *var_button = [[UIButton alloc]init];
        var_button.frame = CGRectMake(RPX(760), RPY(40), RPX(300), RPX(10));
    ...
    
    {
        ...
        UIButton *var_button = [[UIButton alloc]init];
        var_button.frame = CGRectMake(RPX(1000), RPY(40), RPX(300), RPX(10));
        var_button.titleLabel.font = [cls_Tool fun_cusstomFontSize:20];
        var_button.tag = 1000;
        [var_button setTitle:[NSString stringWithFormat:@" %d",userinfo.pro_shu] forState:0];
        [self.view addSubview:var_button];
