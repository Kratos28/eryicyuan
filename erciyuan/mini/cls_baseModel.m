...
- (instancetype)initWithCoder:(NSCoder *)coder {
    ...
    if (self) {
        ...
        self.pro_baseModelQuantity = [coder decodeIntForKey:@"pro_baseModelQuantity"];
        ...
        self.pro_MAXHP = [coder decodeIntegerForKey:@"pro_MAXHP"];
...
- (void)encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeInt:self.pro_baseModelQuantity forKey:@"pro_baseModelQuantity"];
    ...
    [coder encodeInteger:self.pro_MAXHP forKey:@"pro_MAXHP"];
