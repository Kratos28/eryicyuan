...
+ (void )fun_createSignin
{
    NSMutableArray *temp = [NSMutableArray array];
    {
        ...
        zhuangbei.pro_signinImageName = @"img_signin_wp1";
    ...
    
    {
        ...
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp2";
        [temp addObject:zhuangbei];
    ...
    
    {
        ...
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp3";
        [temp addObject:zhuangbei];
    ...
    
    {
        ...
        zhuangbei.pro_signinGold = 20;
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp4";
        [temp addObject:zhuangbei];
    ...
    
    {
        ...
        zhuangbei.pro_signinGold = 20;
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp5";
        [temp addObject:zhuangbei];
    ...
    
    {
        ...
        zhuangbei.pro_signinGold = 20;
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp6";
        [temp addObject:zhuangbei];
    }
    
    {
        ...
        zhuangbei.pro_signinGold = 20;
        zhuangbei.pro_shifouqiandao =  NO;
        zhuangbei.pro_signinImageName = @"img_signin_wp7";
        [temp addObject:zhuangbei];
    }
